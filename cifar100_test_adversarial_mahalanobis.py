...
os.makedirs('cifar100_test_adversarial/penultimate', exist_ok=True)
...
file_list = os.listdir('cifar100_test_adversarial/attention_adversarial_image_numpy')

mahalanobis_distance_list = []

for i in range(1, len(file_list)):
    attention_adversarial_image = np.load(
        f"cifar100_test_adversarial/attention_adversarial_image_numpy/attention_adversarial_image_numpy_{i}.npy")
    ...
    penultimate_path = f'cifar100_test_adversarial/penultimate/penultimate_{i}'
...
os.makedirs('cifar100_test_adversarial/mahalanobis', exist_ok=True)

mahalanobis_distance_list.numpy()

mahalanobis_distance_path = 'cifar100_test_adversarial/mahalanobis/mahalanobis_distance'
